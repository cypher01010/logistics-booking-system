	...
	<?php $form = ActiveForm::begin([
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-body">
								...
								<div class="form-group" style="padding-top: 10px">
									<label class="col-md-3 control-label">Remarks <?php echo ($model->isAttributeRequired('type_products') == true) ? '<span class="required">*</span>' : NULL; ?></label>
									<div class="col-md-9">
		...
		<?php if (Yii::$app->session->get('type') != \app\models\User::USERTYPE_CUSTOMER){ ?>
			<div id="price-change" class="col-md-12">
				<div class="portlet light bg-inverse">
					<div class="portlet-title">
						<div class="caption">
							<span class="caption-subject font-green-sharp ">Signature and Status</span>
							<span class="caption-helper"></span>
						</div>
					</div>
					<div class="portlet-body">
							...
							<div class="col-md-12">
								<div class="form-body">
									<div class="form-group">
										...
										<ul class="sigNav">
											<li class="clearButton"><a href="#clear" id="clear-signature">Clear</a></li>
										</ul>
									</div>
								</div>
		...
		<div id="price-change" class="col-md-12">
			<div class="portlet light bg-inverse">
				<div class="portlet-title">
					<div class="caption">
						<span class="caption-subject font-green-sharp ">Update Delivery</span>
						<span class="caption-helper"></span>
					</div>
				</div>
				<div class="portlet-body">
					<p>Click the button below to update delivery details</p>
					<br />
					<div class="row">
						<div class="col-md-12">
							<div class="form-body">
								<div class="form-group">
									<?= Html::submitButton('Update Delivery', ['class' => 'btn btn-primary']) ?>
								</div>
							</div>
						</div>
					</div>
...
<?php if($signature == true) { ?>
	var deliverySignature = $('#delivery-form').signaturePad({
		...
		drawItDesc: null,
		onDrawEnd : function() {
			$('#deliveryform-signaturepad').val(deliverySignature.getSignatureImage());
		}
	});
	$(document).on('click', '#clear-signature', function() {
		$('#deliveryform-signaturepad').val('');
	});
<?php } ?>
