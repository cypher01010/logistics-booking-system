...
$params['path'] = [
	...
	'document' => realpath(dirname(__FILE__)) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'public_html' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR,
];
...
$config = [
	...
	'components' => [
		...
		'db' => [
			...
			'dsn' => 'mysql:host=localhost;dbname=meiybf8i_rrl_production',
			'username' => 'meiybf8i_rrl',
			'password' => '9?:$Km/=',
			'charset' => 'utf8',
		],
	],
